...
import com.youwu.qucanguibuhuo.databinding.ActivityBHRecordBinding;
...
public class BHRecordActivity extends BaseActivity<ActivityBHRecordBinding, BHRecordViewModel> {
    ...
    public int initContentView(Bundle savedInstanceState) {
        return R.layout.activity_b_h_record;
    }
    ...
    @Override
    public BHRecordViewModel initViewModel() {
        //使用自定义的ViewModelFactory来创建ViewModel，如果不重写该方法，则默认会调用LoginViewModel(@NonNull Application application)构造方法
        AppViewModelFactory factory = AppViewModelFactory.getInstance(getApplication());
        return ViewModelProviders.of(this, factory).get(BHRecordViewModel.class);
    }
    ...
    public void initData() {
        ...
        if (type==1){
            binding.textTop.setText("补货记录");
    }else {
            binding.textTop.setText("清货记录");
        }
