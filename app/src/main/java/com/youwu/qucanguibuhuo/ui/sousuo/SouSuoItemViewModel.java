...
public class SouSuoItemViewModel extends ItemViewModel<SouSuoViewModel> {
    public ObservableField<OrderBean> entity = new ObservableField<>();
    public Drawable drawableImg;

    public SouSuoItemViewModel(@NonNull SouSuoViewModel viewModel, OrderBean entity) {
        super(viewModel);
    ...
    public BindingCommand itemClick = new BindingCommand(new BindingAction() {
        ...
        public void call() {
            ...
            //拿到position
            int position = viewModel.YuYueList.indexOf(SouSuoItemViewModel.this);
            //跳转到订单详情
