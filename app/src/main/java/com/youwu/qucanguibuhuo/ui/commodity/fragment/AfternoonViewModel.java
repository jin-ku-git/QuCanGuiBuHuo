...
public class AfternoonViewModel extends BaseViewModel<DemoRepository> {

    public ObservableField<UserBean> user = new ObservableField<>();
    //下拉刷新完成
    public SingleLiveEvent finishRefreshing = new SingleLiveEvent<>();

    public AfternoonViewModel(@NonNull Application application, DemoRepository repository) {
