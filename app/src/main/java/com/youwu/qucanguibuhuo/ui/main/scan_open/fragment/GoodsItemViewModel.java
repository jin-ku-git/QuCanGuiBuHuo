...
public class GoodsItemViewModel extends ItemViewModel<GoodsViewModel> {
    ...
    public GoodsItemViewModel(@NonNull GoodsViewModel viewModel, OrderBean entity) {
        super(viewModel);
    ...
    public BindingCommand itemClick = new BindingCommand(new BindingAction() {
        ...
        public void call() {
            ...
            //拿到position
            int position = viewModel.OrderList.indexOf(GoodsItemViewModel.this);
            //跳转到订单详情
    ...
    //开门补货的点击事件
    public BindingCommand OpenBHClick = new BindingCommand(new BindingAction() {
        @Override
        public void call() {
            viewModel.open_type.setValue(entity.get());
