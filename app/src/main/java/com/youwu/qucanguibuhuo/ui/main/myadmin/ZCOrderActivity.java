...
import com.youwu.qucanguibuhuo.databinding.ActivityZCOrderBinding;
...
public class ZCOrderActivity extends BaseActivity<ActivityZCOrderBinding, ZCOrderViewModel> {
    ...
    public int initContentView(Bundle savedInstanceState) {
        return R.layout.activity_z_c_order;
    }
    ...
    @Override
    public ZCOrderViewModel initViewModel() {
        //使用自定义的ViewModelFactory来创建ViewModel，如果不重写该方法，则默认会调用LoginViewModel(@NonNull Application application)构造方法
        AppViewModelFactory factory = AppViewModelFactory.getInstance(getApplication());
        return ViewModelProviders.of(this, factory).get(ZCOrderViewModel.class);
    }
    ...
    protected List<Fragment> pagerFragment() {
        ...
        list.add(new InventoryFragment("1",1));
        list.add(new InventoryFragment("2",1));
