...
public class InventoryItemViewModel extends ItemViewModel<InventoryViewModel> {
    ...
    public InventoryItemViewModel(@NonNull InventoryViewModel viewModel, OrderBean entity) {
        super(viewModel);
    ...
    public BindingCommand itemClick = new BindingCommand(new BindingAction() {
        ...
        public void call() {
            ...
            //拿到position
            int position = viewModel.OrderList.indexOf(InventoryItemViewModel.this);
            //跳转到订单详情
