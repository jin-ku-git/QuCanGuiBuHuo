...
public class LoginViewModel extends BaseViewModel<DemoRepository> {
    ...
    public class UIChangeObservable {
        ...
        //是否同意阅读观察者
        public SingleLiveEvent<String> checkBoxEvent = new SingleLiveEvent<>();
        //更新监听
                ...
                .subscribe(new DisposableObserver<BaseBean<Object>>() {
                    ...
                    public void onNext(BaseBean response) {
                        ...
                        if (0==response.getCode()){
                            ...
                            uc.upDateEvent.setValue(upDateBean);
                        }else {
...
//        RaJava登录
        model.CALOGIN(userName.get(),password.get())
                .compose(RxUtils.schedulersTransformer()) //线程调度
                .compose(RxUtils.exceptionTransformer())
                .doOnSubscribe(new Consumer<Disposable>() {
                    @Override
                    ...
                    public void onNext(BaseBean response) {
                        ...
                        if (0==response.getCode()){
                            ...
                            try {
                                ...
                                String token = arr.optString("token");//token
                                AppApplication.spUtils.put("token", token);
                                //跳转到首页
