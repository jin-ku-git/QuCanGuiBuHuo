...
public class InventoryTGItemViewModel extends ItemViewModel<InventoryViewModel> {
    public ObservableField<OrderBean> entity = new ObservableField<>();
    public Drawable drawableImg;

    public InventoryTGItemViewModel(@NonNull InventoryViewModel viewModel, OrderBean entity) {
        super(viewModel);
    ...
    public BindingCommand itemClick = new BindingCommand(new BindingAction() {
        ...
        public void call() {
            ...
            //拿到position
            int position = viewModel.TuanGouList.indexOf(InventoryTGItemViewModel.this);
            //跳转到订单详情
