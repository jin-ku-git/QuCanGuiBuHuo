...
import com.youwu.qucanguibuhuo.BuildConfig;
...
import com.youwu.qucanguibuhuo.update_model.OkHttp3Connection;
import com.youwu.qucanguibuhuo.update_model.UpdateModel;
...
//        }
        ...
        spUtils = new SPUtils("com.youwu.qucanguibuhuo");
        gson=new Gson();
        ...
        builder.connectTimeout(30_000, TimeUnit.SECONDS)
                ...
                .addInterceptor(new MonitorInterceptor(getBaseContext()))
